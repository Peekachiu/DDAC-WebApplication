...
export default function AdminDashboard({ user }) {
  ...
  const getStatusIcon = (status) => {
    switch (status.toLowerCase()) {
      ...
      case 'info': return <TrendingUp className="h-5 w-5 text-[#f37021]" />;
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <button onClick={() => window.location.href = '/admin/residents'} className="rounded-lg border border-gray-200 p-4 text-left transition hover:border-[#f37021] hover:bg-[#f37021]/10">
