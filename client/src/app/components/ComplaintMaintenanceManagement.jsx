...
export default function ComplaintMaintenanceManagement({ user }) {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'in-progress': return <Badge className="bg-[#f37021]/10 text-[#f37021]">In Progress</Badge>;
    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl text-[#f37021]">{inProgressCount}</p>
                <p className="mt-1 text-xs text-gray-500">Being handled</p>
              </div>
              <div className="rounded-lg bg-[#f37021]/10 p-3">
                <Wrench className="h-6 w-6 text-[#f37021]" />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
        <DialogContent>
          ...
          {selectedRequest && (
            <div className="mb-4 rounded-lg bg-[#f37021]/10 p-4">
