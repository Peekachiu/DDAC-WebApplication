        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <User className="h-5 w-5 text-[#f37021]" />
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="p-2 bg-gray-50 rounded shadow-md text-sm text-gray-700">
                {user.name}
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="p-2 bg-gray-50 rounded shadow-md text-sm text-gray-700 font-semibold">
                {user.unit}
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-9 border-none shadow-md"
