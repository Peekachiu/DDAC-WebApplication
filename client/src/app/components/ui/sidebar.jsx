    ...
    >
      ...
      >
        <div
          ...
          className="glass group-data-[variant=floating]:border-0 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg"
        >
          {children}
        </div>
      </div>
