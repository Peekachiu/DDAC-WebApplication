...
function ResidentNotifications({ user }) {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case 'info': return <Info className="h-5 w-5 text-[#f37021]" />;
      ...
      default: return <Info className="h-5 w-5 text-[#f37021]" />;
    }
  };

  const getTypeBadge = (type) => {
    switch (type) {
      case 'info': return <Badge className="bg-[#f37021]/10 text-[#f37021]">Info</Badge>;
  ...
  const renderNotification = (notification) => (
    <Card key={notification.id} className={!notification.read ? 'border-l-4 border-l-[#f37021]' : ''}>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  {!notification.read && (
                    <Badge className="bg-[#f37021]/10 text-[#f37021] text-xs">New</Badge>
                  )}
                </div>
